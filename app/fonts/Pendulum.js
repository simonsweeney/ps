/*
 ...
 MyFonts Webfont Build ID 2859714, 2014-08-08T09:42:02-0400
...
for(var fonts=[{fontFamily:"Gibson-LightIt",url:wfpath+"2BA2C2_0"+suffix+"_0."+webfontType},{fontFamily:"Gibson-BoldItalic",url:wfpath+"2BA2C2_1"+suffix+"_0."+webfontType},{fontFamily:"Gibson-Bold",url:wfpath+"2BA2C2_2"+suffix+"_0."+webfontType},{fontFamily:"Gibson-Light",url:wfpath+"2BA2C2_3"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=
